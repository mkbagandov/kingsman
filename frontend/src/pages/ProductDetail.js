    ...
    <div className="product-detail-page">
      ...
      <div className="product-detail-content">
        ...
        <div className="product-detail-info">
          ...
          <p className="product-detail-price"><FaDollarSign className="icon" /> Price: {product.price.toFixed(2)}</p>
          <p className="product-detail-category"><FaTag className="icon" /> Category: {categoryName}</p>
          <p className="product-detail-quantity"><FaBoxes className="icon" /> Quantity: {product.quantity}</p>
